...
namespace miniUrl.Models
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="miniurl")]
    ...
    partial void OnCreatedDateChanged();
		...
		[Column(Storage="_LongUrl", DbType="VarChar(MAX) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Hash", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string Hash
		{
			get
			{
		...
		[Association(Name="Url_UrlView", Storage="_UrlViews", ThisKey="Id", OtherKey="UrlId")]
    ...
    partial void OnUrlIdChanged();
		...
		[Column(Storage="_UrlId", DbType="Int NOT NULL")]
		public int UrlId
		{
			get
			{
		...
		[Association(Name="Url_UrlView", Storage="_Url", ThisKey="UrlId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Url Url
		{
			get
			{
